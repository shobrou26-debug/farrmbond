...
// Free tier: 300 emails/day (vs Resend 100/day)
// ============================================================

const BREVO_API_KEY = process.env.BREVO_API_KEY;
const FROM_EMAIL = process.env.FROM_EMAIL || "notifications@farmbond.com";
const FROM_NAME = process.env.FROM_NAME || "FarmBond";
...
/**
 * Helper function to send email via Brevo (Sendinblue)
 */
